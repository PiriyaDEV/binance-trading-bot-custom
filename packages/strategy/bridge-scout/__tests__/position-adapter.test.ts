...
import { bridgeScoutPositionAdapter as a } from '../src/position-adapter.js';
import { initialBridgeScoutState, type BridgeScoutState } from '../src/schema.js';

const open: BridgeScoutState = { schemaVersion: '1.0.0', avgEntryPrice: '100', heldQuantity: '2' };
const flat = initialBridgeScoutState();
const foreign = { schemaVersion: '0.0.1', avgEntryPrice: '1', heldQuantity: '1' } as unknown;

describe('bridgeScoutPositionAdapter', () => {
